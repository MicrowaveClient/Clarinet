...
public class GuiPasswordField extends Gui {
    ...
    public void mouseClicked(int par1, int par2, int par3) {
        boolean var4 = par1 >= this.xPos && par1 < this.xPos + this.width && par2 >= this.yPos
    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                ...
                RenderMethods.drawBorderedRect(xPos, yPos, this.xPos + width, yPos + height, 1F, !isFocused ? 0x88111111 : 0xbb222222, 0xAA000000);
            }
            ...
            if (var4.length() > 0) {
                var9 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(text.replaceAll("(?s).", "*"),
                        (float) var7, (float) var8, var1);
            }
