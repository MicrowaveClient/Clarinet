...
public class GuiShaders extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.CLOUD_SHADOW, btnX, 6 * stepY + baseY, btnWidth, btnHeight));
        ...
        this.buttonList.add(new GuiButton(201, shaderListWidth / 4 - btnFolderWidth / 2, this.height - 25, btnFolderWidth, btnHeight, "Shaders Folder"));
        ...
        this.buttonList.add(new GuiButton(203, btnX, this.height - 25, btnWidth, btnHeight, "Shader Options..."));
        this.updateButtons();
    }
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            if (button instanceof GuiButtonEnumShaderOption) {
                ...
                switch (GuiShaders.NamelessClass481687518.$SwitchMap$shadersmod$client$EnumShaderOption[var12.getEnumShaderOption().ordinal()]) {
                    case 1:
    ...
    static class NamelessClass481687518 {
