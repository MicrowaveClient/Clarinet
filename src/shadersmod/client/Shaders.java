...
public class Shaders {
    ...
    private static void setEnumShaderOption(EnumShaderOption eso, String str) {
        ...
        switch (Shaders.NamelessClass1797126575.$SwitchMap$shadersmod$client$EnumShaderOption[eso.ordinal()]) {
            case 1:
    ...
    public static void beginRender(Minecraft minecraft, float partialTicks, long finishTimeNano) {
        ...
        isSleeping = var8 instanceof EntityLiving && ((EntityLiving) var8).isPlayerSleeping();
        ...
        isEyeInWater = mc.gameSettings.thirdPersonView == 0 && !((EntityLivingBase) mc.getRenderViewEntity()).isPlayerSleeping() && mc.thePlayer.isInsideOfMaterial(Material.water) ? 1 : 0;
    ...
    static class NamelessClass1797126575 {
