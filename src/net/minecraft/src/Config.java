...
public class Config {
    ...
    public static final String OF_RELEASE = "H2";
    public static final String VERSION = "OptiFine_1.8_HD_U_H2";
    ...
    public static String getVersion() {
        return "OptiFine_1.8_HD_U_H2";
    }

    public static String getVersionShaders() {
        String shaderPack = Shaders.getShaderPackName();
        return shaderPack == null ? "OptiFine_1.8_HD_U_H2" : "OptiFine_1.8_HD_U_H2, " + shaderPack;
    }
    ...
    public static DefaultResourcePack getDefaultResourcePack() {
        if (defaultResourcePack == null) {
            ...
            try {
                ...
                dbg("Error getting default resource pack: " + var4.getClass().getName() + ": " + var4.getMessage());
            }
        ...
        if (samples > 0) {
            ...
            if (!Minecraft.isRunningOnMac && getDefaultResourcePack() != null) {
                ...
                try {
                    ...
                    dbg("Error setting window icon: " + var11.getClass().getName() + ": " + var11.getMessage());
                } finally {
    ...
    public static DynamicTexture getMojangLogoTexture(DynamicTexture texDefault) {
        try {
            ...
            dbg(var4.getClass().getName() + ": " + var4.getMessage());
            return texDefault;
        }
    }
