...
public class Village {
    ...
    public VillageDoorInfo getNearestDoor(BlockPos pos) {
        ...
        while (var4.hasNext()) {
            ...
            int var6 = var5.getDistanceToDoorBlockSq(pos);
    ...
    public void addOrRenewAgressor(EntityLivingBase entitylivingbaseIn) {
        ...
        do {
            if (!var2.hasNext()) {
                this.villageAgressors.add(new Village.VillageAgressor(entitylivingbaseIn, this.tickCounter));
                return;
            }

            var3 = (Village.VillageAgressor) var2.next();
        }
        while (var3.agressor != entitylivingbaseIn);
    ...
    public EntityLivingBase findNearestVillageAggressor(EntityLivingBase entitylivingbaseIn) {
        ...
        for (int var5 = 0; var5 < this.villageAgressors.size(); ++var5) {
            ...
            double var7 = var6.agressor.getDistanceSqToEntity(entitylivingbaseIn);
    ...
    private boolean isWoodDoor(BlockPos pos) {
        Block var2 = this.worldObj.getBlockState(pos).getBlock();
