...
public class ContainerPlayer extends Container {
    ...
    public void onContainerClosed(EntityPlayer playerIn) {
        CloseInventorySubject closeInventorySubject = new CloseInventorySubject();
        Glade.getInstance().getSubjectManager().dispatch(closeInventorySubject);
        if (closeInventorySubject.isCancelled())
            return;
