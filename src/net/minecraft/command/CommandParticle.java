    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 8) {
            ...
            if (!var3) {
                ...
                double var32 = (double) ((float) parseDouble(var31.xCoord, args[1], true));
                double var9 = (double) ((float) parseDouble(var31.yCoord, args[2], true));
                double var11 = (double) ((float) parseDouble(var31.zCoord, args[3], true));
