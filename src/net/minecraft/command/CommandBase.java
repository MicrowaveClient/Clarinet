...
public abstract class CommandBase implements ICommand {
    ...
    public static BlockPos parseBlockPos(ICommandSender sender, String[] args, int startIndex, boolean centerBlock) throws NumberInvalidException {
        ...
        return new BlockPos(parseDouble((double) var4.getX(), args[startIndex], -30000000, 30000000, centerBlock), parseDouble((double) var4.getY(), args[startIndex + 1], 0, 256, false), parseDouble((double) var4.getZ(), args[startIndex + 2], -30000000, 30000000, centerBlock));
    }
