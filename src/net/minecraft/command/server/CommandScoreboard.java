    ...
    protected void listTeams(ICommandSender p_147186_1_, String[] p_147186_2_, int p_147186_3_) throws CommandException {
        ...
        if (p_147186_2_.length > p_147186_3_) {
            ...
            while (var11.hasNext()) {
                ...
                p_147186_1_.addChatMessage(new ChatComponentTranslation("commands.scoreboard.teams.list.entry", new Object[]{var8.getRegisteredName(), var8.getTeamName(), Integer.valueOf(var8.getMembershipCollection().size())}));
            }
        }
    }
