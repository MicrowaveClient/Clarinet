...
public class MathHelper {
    ...
    public static long floor_double_long(double value) {
        ...
        return value < (double) var2 ? var2 - 1L : var2;
    }
    ...
    public static double average(long[] values) {
        ...
        return (double) var1 / (double) values.length;
    }
    ...
    public static UUID getRandomUuid(Random rand) {
        long var1 = rand.nextLong() & -61441L | 16384L;
        long var3 = rand.nextLong() & 4611686018427387903L | Long.MIN_VALUE;
