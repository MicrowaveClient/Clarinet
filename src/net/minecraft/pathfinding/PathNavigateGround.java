...
public class PathNavigateGround extends PathNavigate {
    ...
    private boolean isSafeToStandAt(int x, int y, int z, int sizeX, int sizeY, int sizeZ, Vec3 vec31, double p_179683_8_, double p_179683_10_) {
        ...
        if (!this.isPositionClear(var12, y, var13, sizeX, sizeY, sizeZ, vec31, p_179683_8_, p_179683_10_)) {
            return false;
        } else {
            for (int var14 = var12; var14 < var12 + sizeX; ++var14) {
                for (int var15 = var13; var15 < var13 + sizeZ; ++var15) {
                    double var16 = (double) var14 + 0.5D - vec31.xCoord;
                    double var18 = (double) var15 + 0.5D - vec31.zCoord;

                    if (var16 * p_179683_8_ + var18 * p_179683_10_ >= 0.0D) {
                        Block var20 = this.worldObj.getBlockState(new BlockPos(var14, y - 1, var15)).getBlock();
