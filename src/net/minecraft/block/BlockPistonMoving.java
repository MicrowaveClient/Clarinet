        ...
        if (extendingBlock.getBlock() != this && extendingBlock.getBlock().getMaterial() != Material.air) {
            ...
            if (var6 == null) {
                ...
                if (direction.getFrontOffsetX() < 0) {
                    var7 -= (double) ((float) direction.getFrontOffsetX() * progress);
                } else {
                    var13 -= (double) ((float) direction.getFrontOffsetX() * progress);
                }

                if (direction.getFrontOffsetY() < 0) {
                    var9 -= (double) ((float) direction.getFrontOffsetY() * progress);
                } else {
                    var15 -= (double) ((float) direction.getFrontOffsetY() * progress);
                }

                if (direction.getFrontOffsetZ() < 0) {
                    var11 -= (double) ((float) direction.getFrontOffsetZ() * progress);
                } else {
                    var17 -= (double) ((float) direction.getFrontOffsetZ() * progress);
                }
