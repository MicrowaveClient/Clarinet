...
public class Block {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity) {
        ...
        BlockBoundingBoxSubject blockBoundingBoxSubject = new BlockBoundingBoxSubject(this, var7, pos);
        Glade.getInstance().getSubjectManager().dispatch(blockBoundingBoxSubject);

        if (blockBoundingBoxSubject.isCancelled())
            return;

        if (var7 != blockBoundingBoxSubject.getBoundingBox())
            var7 = blockBoundingBoxSubject.getBoundingBox();
    ...
    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPos pos) {
        ...
        return var4 < 0.0F ? 0.0F : (!playerIn.canHarvestBlock(this) ? playerIn.getToolDigEfficiency(this) / var4 / 100.0F : playerIn.getToolDigEfficiency(this) / var4 / 30.0F);
    }
