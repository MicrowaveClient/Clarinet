                                    ...
                                    while (true) {
                                        if (var29 < 4) {
                                            label108:
                                            {
                                                ...
                                                if (!p_77192_1_.isAnyPlayerWithinRangeAt((double) var31, (double) var24, (double) var32, 24.0D) && var37.distanceSq((double) var31, (double) var24, (double) var32) >= 576.0D) {
                                                    if (var27 == null) {
                                                    ...
                                                    if (p_77192_1_.canCreatureTypeSpawnHere(var40, var27, var30) && canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.getPlacementForEntity(var27.entityClass), p_77192_1_, var30)) {
                                                        EntityLiving var33;
