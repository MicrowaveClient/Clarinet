...
public class BiomeGenMesa extends BiomeGenBase {
    ...
    public void genTerrainBlocks(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
        ...
        int var15 = (int) (p_180622_6_ / 3.0D + 3.0D + rand.nextDouble() * 0.25D);
        boolean var25 = Math.cos(p_180622_6_ / 3.0D * Math.PI) > 0.0D;
        int var17 = -1;
        boolean var26 = false;

        for (int var19 = 255; var19 >= 0; --var19) {
            if (chunkPrimerIn.getBlockState(var11, var19, var10).getBlock().getMaterial() == Material.air && var19 < (int) var22) {
                chunkPrimerIn.setBlockState(var11, var19, var10, Blocks.stone.getDefaultState());
            }

            if (var19 <= rand.nextInt(5)) {
                chunkPrimerIn.setBlockState(var11, var19, var10, Blocks.bedrock.getDefaultState());
            } else {
                IBlockState var20 = chunkPrimerIn.getBlockState(var11, var19, var10);
                    ...
                    if (var17 == -1) {
                        ...
                        if (var19 >= 62) {
                            if (this.field_150620_aI && var19 > 86 + var15 * 2) {
                                if (var25) {
                                    chunkPrimerIn.setBlockState(var11, var19, var10, Blocks.dirt.getDefaultState().withProperty(BlockDirt.VARIANT, BlockDirt.DirtType.COARSE_DIRT));
                                } else {
                                    chunkPrimerIn.setBlockState(var11, var19, var10, Blocks.grass.getDefaultState());
                                }
                                ...
                                chunkPrimerIn.setBlockState(var11, var19, var10, var21);
                            } else {
                                chunkPrimerIn.setBlockState(var11, var19, var10, this.topBlock);
                                var26 = true;
                            }
                        } else {
                            chunkPrimerIn.setBlockState(var11, var19, var10, var24);

                            if (var24.getBlock() == Blocks.stained_hardened_clay) {
                                chunkPrimerIn.setBlockState(var11, var19, var10, var24.getBlock().getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE));
                            }
                        }
                    } else if (var17 > 0) {
                        --var17;
                        ...
                        if (var26) {
                            chunkPrimerIn.setBlockState(var11, var19, var10, Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE));
                        } else {
                            var21 = this.func_180629_a(p_180622_4_, var19, p_180622_5_);
                            chunkPrimerIn.setBlockState(var11, var19, var10, var21);
                        }
