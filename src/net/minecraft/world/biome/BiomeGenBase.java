...
public abstract class BiomeGenBase {
    ...
    public List getSpawnableList(EnumCreatureType creatureType) {
        switch (BiomeGenBase.SwitchEnumCreatureType.field_180275_a[creatureType.ordinal()]) {
            case 1:
    ...
    public int getGrassColorAtPos(BlockPos pos) {
        double var2 = (double) MathHelper.clamp_float(this.getFloatTemperature(pos), 0.0F, 1.0F);
    ...
    public final void generateBiomeTerrain(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int p_180628_4_, int p_180628_5_, double p_180628_6_) {
        ...
        int var11 = -1;
        int var12 = (int) (p_180628_6_ / 3.0D + 3.0D + rand.nextDouble() * 0.25D);
        int var13 = p_180628_4_ & 15;
        int var14 = p_180628_5_ & 15;

        for (int var15 = 255; var15 >= 0; --var15) {
            if (var15 <= rand.nextInt(5)) {
                chunkPrimerIn.setBlockState(var14, var15, var13, Blocks.bedrock.getDefaultState());
            } else {
                IBlockState var16 = chunkPrimerIn.getBlockState(var14, var15, var13);
                ...
                if (var16.getBlock().getMaterial() == Material.air) {
                    ...
                    if (var11 == -1) {
                        ...
                        if (var15 >= 62) {
                            chunkPrimerIn.setBlockState(var14, var15, var13, var9);
                        } else if (var15 < 56 - var12) {
                            var9 = null;
                            var10 = Blocks.stone.getDefaultState();
                            chunkPrimerIn.setBlockState(var14, var15, var13, Blocks.gravel.getDefaultState());
                        } else {
                            chunkPrimerIn.setBlockState(var14, var15, var13, var10);
                        }
                    } else if (var11 > 0) {
                        --var11;
                        chunkPrimerIn.setBlockState(var14, var15, var13, var10);
                        ...
                        if (var11 == 0 && var10.getBlock() == Blocks.sand) {
                            var11 = rand.nextInt(4) + Math.max(0, var15 - 63);
    ...
    public static BiomeGenBase getBiomeFromBiomeList(int biomeId, BiomeGenBase biome) {
        if (biomeId >= 0 && biomeId <= biomeList.length) {
            BiomeGenBase var2 = biomeList[biomeId];
            return var2 == null ? biome : var2;
        } else {
