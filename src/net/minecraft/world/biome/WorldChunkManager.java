...
public class WorldChunkManager {
    ...
    public WorldChunkManager(long seed, WorldType p_i45744_3_, String p_i45744_4_) {
        ...
        GenLayer[] var5 = GenLayer.initializeAllBiomeGenerators(seed, p_i45744_3_, p_i45744_4_);
    ...
    public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] biomes, int x, int z, int width, int height) {
        ...
        int[] var6 = this.genBiomes.getInts(x, z, width, height);

        try {
            for (int var7 = 0; var7 < width * height; ++var7) {
                biomes[var7] = BiomeGenBase.getBiomeFromBiomeList(var6[var7], BiomeGenBase.field_180279_ad);
            }
            ...
            var9.addCrashSection("x", Integer.valueOf(x));
            var9.addCrashSection("z", Integer.valueOf(z));
            var9.addCrashSection("w", Integer.valueOf(width));
            var9.addCrashSection("h", Integer.valueOf(height));
