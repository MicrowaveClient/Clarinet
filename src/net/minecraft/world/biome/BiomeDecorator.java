...
public class BiomeDecorator {
    ...
    protected void genDecorations(BiomeGenBase biomeGenBaseIn) {
        ...
        for (var3 = 0; var3 < var2; ++var3) {
            ...
            WorldGenAbstractTree var6 = biomeGenBaseIn.genBigTreeChance(this.randomGenerator);
            var6.func_175904_e();
        ...
        for (var3 = 0; var3 < this.flowersPerChunk; ++var3) {
            ...
            BlockFlower.EnumFlowerType var8 = biomeGenBaseIn.pickRandomFlower(this.randomGenerator, var7);
        ...
        for (var3 = 0; var3 < this.grassPerChunk; ++var3) {
            ...
            biomeGenBaseIn.getRandomWorldGenForGrass(this.randomGenerator).generate(this.currentWorld, this.randomGenerator, this.field_180294_c.add(var4, var11, var5));
        }
    ...
    protected void genStandardOre1(int blockCount, WorldGenerator generator, int minHeight, int maxHeight) {
        ...
        for (var5 = 0; var5 < blockCount; ++var5) {
            BlockPos var6 = this.field_180294_c.add(this.randomGenerator.nextInt(16), this.randomGenerator.nextInt(maxHeight - minHeight) + minHeight, this.randomGenerator.nextInt(16));
            generator.generate(this.currentWorld, this.randomGenerator, var6);
        }
    }
    ...
    protected void genStandardOre2(int blockCount, WorldGenerator generator, int centerHeight, int spread) {
        for (int var5 = 0; var5 < blockCount; ++var5) {
            BlockPos var6 = this.field_180294_c.add(this.randomGenerator.nextInt(16), this.randomGenerator.nextInt(spread) + this.randomGenerator.nextInt(spread) + centerHeight - spread, this.randomGenerator.nextInt(16));
            generator.generate(this.currentWorld, this.randomGenerator, var6);
        }
    }
