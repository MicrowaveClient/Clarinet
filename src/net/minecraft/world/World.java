...
public abstract class World implements IBlockAccess {
    ...
    public List getCollidingBoundingBoxes(Entity entityIn, AxisAlignedBB bb) {
        ...
        for (int var19 = 0; var19 < var18.size(); ++var19) {
            if (entityIn.riddenByEntity != var18 && entityIn.ridingEntity != var18) {
                AxisAlignedBB var20 = ((Entity) var18.get(var19)).getCollisionBoundingBox();
    ...
    public int calculateSkylightSubtracted(float p_72967_1_) {
        ...
        var3 = (float) ((double) var3 * (1.0D - (double) (this.getThunderStrength(p_72967_1_) * 5.0F) / 16.0D));
        var3 = 1.0F - var3;
    ...
    public float getSunBrightness(float p_72971_1_) {
        ...
        var3 = (float) ((double) var3 * (1.0D - (double) (this.getThunderStrength(p_72971_1_) * 5.0F) / 16.0D));
    ...
    public Vec3 getSkyColor(Entity entityIn, float partialTicks) {
        ...
        if (this.lastLightningBolt > 0) {
            var17 = (float) this.lastLightningBolt - partialTicks;
            ...
            for (float var11 = 0.0F; var11 <= 1.0F; var11 = (float) ((double) var11 + var3)) {
                for (float var12 = 0.0F; var12 <= 1.0F; var12 = (float) ((double) var12 + var5)) {
                    for (float var13 = 0.0F; var13 <= 1.0F; var13 = (float) ((double) var13 + var7)) {
                        double var14 = bb.minX + (bb.maxX - bb.minX) * (double) var11;
                        double var16 = bb.minY + (bb.maxY - bb.minY) * (double) var12;
                        double var18 = bb.minZ + (bb.maxZ - bb.minZ) * (double) var13;
