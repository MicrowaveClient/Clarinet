    ...
    public void updateBlockTick(BlockPos pos, Block blockIn, int delay, int priority) {
        ...
        if (this.isAreaLoaded(pos.add(-var6, -var6, -var6), pos.add(var6, var6, var6))) {
            if (blockIn.getMaterial() != Material.air) {
                var5.setScheduledTime((long) delay + this.worldInfo.getWorldTotalTime());
    ...
    public Explosion newExplosion(Entity entityIn, double x, double y, double z, float strength, boolean isFlaming, boolean isSmoking) {
        ...
        while (var12.hasNext()) {
            ...
            if (var13.getDistanceSq(x, y, z) < 4096.0D) {
                ((EntityPlayerMP) var13).playerNetServerHandler.sendPacket(new S27PacketExplosion(x, y, z, strength, var11.getAffectedBlockPositions(), (Vec3) var11.getPlayerKnockbackMap().get(var13)));
            }
        }
