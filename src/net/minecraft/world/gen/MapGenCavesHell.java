...
public class MapGenCavesHell extends MapGenBase {
    ...
    protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimerIn) {
        ...
        for (int var8 = 0; var8 < var7; ++var8) {
            double var9 = (double) (chunkX * 16 + this.rand.nextInt(16));
            double var11 = (double) this.rand.nextInt(128);
            double var13 = (double) (chunkZ * 16 + this.rand.nextInt(16));
            int var15 = 1;

            if (this.rand.nextInt(4) == 0) {
                this.func_180705_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, var9, var11, var13);
            ...
            for (int var16 = 0; var16 < var15; ++var16) {
                ...
                this.func_180704_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, var9, var11, var13, var19 * 2.0F, var17, var18, 0, 0, 0.5D);
            }
        }
    }
}
