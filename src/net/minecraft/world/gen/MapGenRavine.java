...
public class MapGenRavine extends MapGenBase {
    ...
    protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimerIn) {
        if (this.rand.nextInt(50) == 0) {
            double var7 = (double) (chunkX * 16 + this.rand.nextInt(16));
            double var9 = (double) (this.rand.nextInt(this.rand.nextInt(40) + 8) + 20);
            double var11 = (double) (chunkZ * 16 + this.rand.nextInt(16));
            byte var13 = 1;
            ...
            for (int var14 = 0; var14 < var13; ++var14) {
                ...
                this.func_180707_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, var7, var9, var11, var17, var15, var16, 0, 0, 3.0D);
            }
        }
    }
}
