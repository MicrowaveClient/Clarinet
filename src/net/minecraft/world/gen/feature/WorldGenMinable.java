...
public class WorldGenMinable extends WorldGenerator {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        double var5 = (double) ((float) (position.getX() + 8) + MathHelper.sin(var4) * (float) this.numberOfBlocks / 8.0F);
        double var7 = (double) ((float) (position.getX() + 8) - MathHelper.sin(var4) * (float) this.numberOfBlocks / 8.0F);
        double var9 = (double) ((float) (position.getZ() + 8) + MathHelper.cos(var4) * (float) this.numberOfBlocks / 8.0F);
        double var11 = (double) ((float) (position.getZ() + 8) - MathHelper.cos(var4) * (float) this.numberOfBlocks / 8.0F);
        double var13 = (double) (position.getY() + rand.nextInt(3) - 2);
        double var15 = (double) (position.getY() + rand.nextInt(3) - 2);
        ...
        for (int var17 = 0; var17 < this.numberOfBlocks; ++var17) {
            ...
            double var25 = rand.nextDouble() * (double) this.numberOfBlocks / 16.0D;
                        ...
                        if (var38 * var38 + var41 * var41 < 1.0D) {
                            for (int var43 = var33; var43 <= var36; ++var43) {
                                ...
                                if (var38 * var38 + var41 * var41 + var44 * var44 < 1.0D) {
                                    ...
                                    if (this.predicate.apply(worldIn.getBlockState(var46))) {
