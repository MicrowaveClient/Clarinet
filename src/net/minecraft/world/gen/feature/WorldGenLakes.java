                ...
                for (var30 = 0; var30 < 16; ++var30) {
                    for (var8 = 0; var8 < 8; ++var8) {
                        ...
                        if (var32) {
                            ...
                            if (var8 < 4 && !var10.isSolid() && worldIn.getBlockState(position.add(var6, var8, var30)).getBlock() != this.block) {
                                return false;
                            }
                        }
                    }
                ...
                for (var30 = 0; var30 < 16; ++var30) {
                    for (var8 = 0; var8 < 8; ++var8) {
                        if (var4[(var6 * 16 + var30) * 8 + var8]) {
                            worldIn.setBlockState(position.add(var6, var8, var30), var8 >= 4 ? Blocks.air.getDefaultState() : this.block.getDefaultState(), 2);
                        }
                    }
                }
            }
