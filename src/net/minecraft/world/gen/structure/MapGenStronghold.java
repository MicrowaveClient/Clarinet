...
public class MapGenStronghold extends MapGenStructure {
    ...
    protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
        ...
        for (int var5 = 0; var5 < var14; ++var5) {
            ...
            if (chunkX == var15.chunkXPos && chunkZ == var15.chunkZPos) {
                return true;
            }
        }
    ...
    protected StructureStart getStructureStart(int chunkX, int chunkZ) {
        ...
        for (var3 = new MapGenStronghold.Start(this.worldObj, this.rand, chunkX, chunkZ); var3.getComponents().isEmpty() || ((StructureStrongholdPieces.Stairs2) var3.getComponents().get(0)).strongholdPortalRoom == null; var3 = new MapGenStronghold.Start(this.worldObj, this.rand, chunkX, chunkZ)) {
            ;
        }
