    ...
    public void cacheActiveRenderInfo(World worldIn, FontRenderer textRendererIn, Entity livingPlayerIn, Entity pointedEntityIn, GameSettings optionsIn, float partialTicks) {
        ...
        if (livingPlayerIn instanceof EntityLivingBase && ((EntityLivingBase) livingPlayerIn).isPlayerSleeping()) {
            ...
            if (Reflector.callBoolean(Reflector.ForgeBlock_isBed, new Object[]{worldIn, new BlockPos(livingPlayerIn), (EntityLivingBase) livingPlayerIn})) {
                EnumFacing var9 = (EnumFacing) Reflector.call(var8, Reflector.ForgeBlock_getBedDirection, new Object[]{worldIn, new BlockPos(livingPlayerIn)});
                int var91 = var9.getHorizontalIndex();
                this.playerViewY = (float) (var91 * 90 + 180);
                this.playerViewX = 0.0F;
            } else if (var8 == Blocks.bed) {
                int var92 = ((EnumFacing) var7.getValue(BlockBed.FACING)).getHorizontalIndex();
