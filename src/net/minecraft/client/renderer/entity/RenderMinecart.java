...
public class RenderMinecart extends Render {
    ...
    public void doRender(EntityMinecart entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        double var15 = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * (double) partialTicks;
        double var17 = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * (double) partialTicks;
        double var19 = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * (double) partialTicks;
        ...
        float var30 = (float) entity.getRollingAmplitude() - partialTicks;
        ...
        if (var30 > 0.0F) {
            GlStateManager.rotate(MathHelper.sin(var30) * var30 * var31 / 10.0F * (float) entity.getRollingDirection(), 1.0F, 0.0F, 0.0F);
        }
