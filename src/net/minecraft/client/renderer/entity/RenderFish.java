...
public class RenderFish extends Render {
    ...
    public void func_180558_a(EntityFishHook fishHook, double p_180558_2_, double p_180558_4_, double p_180558_6_, float p_180558_8_, float p_180558_9_) {
        ...
        if (fishHook.angler != null) {
            ...
            double var24 = fishHook.angler.prevPosX + (fishHook.angler.posX - fishHook.angler.prevPosX) * (double) p_180558_9_ + var23.xCoord;
            double var26 = fishHook.angler.prevPosY + (fishHook.angler.posY - fishHook.angler.prevPosY) * (double) p_180558_9_ + var23.yCoord;
            double var28 = fishHook.angler.prevPosZ + (fishHook.angler.posZ - fishHook.angler.prevPosZ) * (double) p_180558_9_ + var23.zCoord;
            double var30 = (double) fishHook.angler.getEyeHeight();
            ...
            if (this.renderManager.options != null && this.renderManager.options.thirdPersonView > 0 || fishHook.angler != Minecraft.getMinecraft().thePlayer) {
                ...
                double var37 = 0.35D;
                double var39 = 0.8D;
                var24 = fishHook.angler.prevPosX + (fishHook.angler.posX - fishHook.angler.prevPosX) * (double) p_180558_9_ - var35 * 0.35D - var33 * 0.8D;
                var26 = fishHook.angler.prevPosY + var30 + (fishHook.angler.posY - fishHook.angler.prevPosY) * (double) p_180558_9_ - 0.45D;
                var28 = fishHook.angler.prevPosZ + (fishHook.angler.posZ - fishHook.angler.prevPosZ) * (double) p_180558_9_ - var33 * 0.35D + var35 * 0.8D;
                var30 = fishHook.angler.isSneaking() ? -0.1875D : 0.0D;
            }

            double var47 = fishHook.prevPosX + (fishHook.posX - fishHook.prevPosX) * (double) p_180558_9_;
            double var34 = fishHook.prevPosY + (fishHook.posY - fishHook.prevPosY) * (double) p_180558_9_ + 0.25D;
            double var36 = fishHook.prevPosZ + (fishHook.posZ - fishHook.prevPosZ) * (double) p_180558_9_;
