...
public class RenderDragon extends RenderLiving {
    ...
    protected void func_180575_a(EntityDragon dragon, float p_180575_2_, float p_180575_3_, float p_180575_4_) {
        ...
        if (dragon.deathTime > 0) {
            float var7 = ((float) dragon.deathTime + p_180575_4_ - 1.0F) / 20.0F * 1.6F;
    ...
    protected void renderModel(EntityDragon entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        if (entitylivingbaseIn.deathTicks > 0) {
            float var8 = (float) entitylivingbaseIn.deathTicks / 200.0F;
    ...
    protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_) {
        float var9 = (float) dragon.healingEnderCrystal.innerRotation + p_180574_8_;
        float var10 = MathHelper.sin(var9 * 0.2F) / 2.0F + 0.5F;
        var10 = (var10 * var10 + var10) * 0.2F;
        float var11 = (float) (dragon.healingEnderCrystal.posX - dragon.posX - (dragon.prevPosX - dragon.posX) * (double) (1.0F - p_180574_8_));
        float var12 = (float) ((double) var10 + dragon.healingEnderCrystal.posY - 1.0D - dragon.posY - (dragon.prevPosY - dragon.posY) * (double) (1.0F - p_180574_8_));
        float var13 = (float) (dragon.healingEnderCrystal.posZ - dragon.posZ - (dragon.prevPosZ - dragon.posZ) * (double) (1.0F - p_180574_8_));
        ...
        float var18 = 0.0F - ((float) dragon.ticksExisted + p_180574_8_) * 0.01F;
        float var19 = MathHelper.sqrt_float(var11 * var11 + var12 * var12 + var13 * var13) / 32.0F - ((float) dragon.ticksExisted + p_180574_8_) * 0.01F;
    ...
    protected void rotateCorpse(EntityLivingBase bat, float p_77043_2_, float p_77043_3_, float partialTicks) {
        this.func_180575_a((EntityDragon) bat, p_77043_2_, p_77043_3_, partialTicks);
    }
