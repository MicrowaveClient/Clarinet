        ...
        for (Iterator var6 = quads.iterator(); var6.hasNext(); this.renderQuad(renderer, var7, var8)) {
            ...
            if (var5 && var7.hasTintIndex()) {
                ...
                if (Config.isCustomColors()) {
                    var8 = CustomColors.getColorFromItemStack(stack, var7.getTintIndex(), var8);
                }
    ...
    public void renderItemModelForEntity(ItemStack stack, EntityLivingBase entityToRenderFor, ItemCameraTransforms.TransformType cameraTransformType) {
        ...
        if (entityToRenderFor instanceof EntityPlayer) {
            ...
            if (var6 == Items.fishing_rod && var5.fishEntity != null) {
                ...
                var7 = (ModelResourceLocation) Reflector.call(var6, Reflector.ForgeItem_getModel, new Object[]{stack, var5, Integer.valueOf(var5.getItemInUseCount())});
            }
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text) {
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                String itemDamaged = text == null ? String.valueOf(stack.stackSize) : text;

                if (text == null && stack.stackSize < 1) {
                    itemDamaged = EnumChatFormatting.RED + String.valueOf(stack.stackSize);
                }

                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                fr.drawStringWithShadow(itemDamaged, (float) (xPosition + 19 - 2 - fr.getStringWidth(itemDamaged)), (float) (yPosition + 6 + 3), 16777215);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
            }

            boolean itemDamaged1 = stack.isItemDamaged();

            if (Reflector.ForgeItem_showDurabilityBar.exists()) {
                itemDamaged1 = Reflector.callBoolean(stack.getItem(), Reflector.ForgeItem_showDurabilityBar, new Object[]{stack});
            }
            ...
            if (itemDamaged1) {
                ...
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
                    double var8 = Reflector.callDouble(stack.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, new Object[]{stack});
