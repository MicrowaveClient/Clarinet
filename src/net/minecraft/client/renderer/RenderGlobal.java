...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    ...
    public void renderEntities(Entity renderViewEntity, ICamera camera, float partialTicks) {
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            double var4 = renderViewEntity.prevPosX + (renderViewEntity.posX - renderViewEntity.prevPosX) * (double) partialTicks;
            double var6 = renderViewEntity.prevPosY + (renderViewEntity.posY - renderViewEntity.prevPosY) * (double) partialTicks;
            double var8 = renderViewEntity.prevPosZ + (renderViewEntity.posZ - renderViewEntity.prevPosZ) * (double) partialTicks;
            ...
            if (this.isRenderEntityOutlines()) {
                ...
                for (var18 = 0; var18 < var17.size(); ++var18) {
                    ...
                    if (!forgeEntityPass || Reflector.callBoolean(var19, Reflector.ForgeEntity_shouldRenderInPass, new Object[]{Integer.valueOf(pass)})) {
                        ...
                        boolean var25 = var19.isInRangeToRender3d(var4, var6, var8) && (var19.ignoreFrustumCheck || camera.isBoundingBoxInFrustum(var19.getEntityBoundingBox()) || var19.riddenByEntity == this.mc.thePlayer) && var19 instanceof EntityPlayer;
            ...
            while (var35.hasNext()) {
                ...
                Chunk fontRenderer = this.theWorld.getChunkFromBlockCoords(var26.renderChunk.getPosition());
                Iterator var32 = fontRenderer.getEntityLists()[var26.renderChunk.getPosition().getY() / 16].iterator();
            ...
            while (var35.hasNext()) {
                var26 = (RenderGlobal.ContainerLocalRenderInformation) var35.next();
                Iterator var38 = var26.renderChunk.getCompiledChunk().getTileEntities().iterator();
    ...
    public String getDebugInfoEntities() {
        return "E: " + this.countEntitiesRendered + "/" + this.countEntitiesTotal + ", B: " + this.countEntitiesHidden + ", I: " + (this.countEntitiesTotal - this.countEntitiesHidden - this.countEntitiesRendered) + ", " + Config.getVersionShaders();
    }
    ...
    public void setupTerrain(Entity viewEntity, double partialTicks, ICamera camera, int frameCount, boolean playerSpectator) {
        ...
        if (Shaders.isShadowPass) {
            ...
            if (!var22 && this.displayListEntitiesDirty) {
                ...
                for (int var39 = 0; var39 < this.viewFrustum.renderChunks.length; ++var39) {
                    var41 = this.viewFrustum.renderChunks[var39];
                    RenderGlobal.ContainerLocalRenderInformation var36 = new RenderGlobal.ContainerLocalRenderInformation(var41, (EnumFacing) null, 0, null);
                    BlockPos var37 = var41.getPosition();

                    if (!var41.compiledChunk.isEmpty() || var41.isNeedsUpdate()) {
                        if (var36 == null) {
                            var36 = new RenderGlobal.ContainerLocalRenderInformation(var41, (EnumFacing) null, 0, null);
                        }

                        this.renderInfos.add(var36);
                    }
        ...
        if (!var22 && this.displayListEntitiesDirty && !Shaders.isShadowPass) {
            ...
            Deque var371 = this.visibilityDeque;
            boolean var391 = this.mc.renderChunksMany;
            int var30;
            ...
            if (var20 == null) {
                ...
                for (var30 = -this.renderDistanceChunks; var30 <= this.renderDistanceChunks; ++var30) {
                    for (int var43 = -this.renderDistanceChunks; var43 <= this.renderDistanceChunks; ++var43) {
                        ...
                        if (var45 != null && ((ICamera) camera).isBoundingBoxInFrustum(var45.boundingBox)) {
                            ...
                            var371.add(new RenderGlobal.ContainerLocalRenderInformation(var45, (EnumFacing) null, 0, (Object) null));
                        }
                    }
                }
            } else {
                boolean var411 = false;
                RenderGlobal.ContainerLocalRenderInformation var431 = new RenderGlobal.ContainerLocalRenderInformation(var20, (EnumFacing) null, 0, (Object) null);
                Set var44 = SET_ALL_FACINGS;

                if (!var44.isEmpty() && var44.size() == 1) {
                    Vector3f var461 = this.getViewVector(viewEntity, partialTicks);
                    EnumFacing var31 = EnumFacing.getFacingFromVector(var461.x, var461.y, var461.z).getOpposite();
                    var44.remove(var31);
                }
                ...
                if (var411 && !playerSpectator) {
                    this.renderInfos.add(var431);
                } else {
            ...
            EnumFacing[] var42 = EnumFacing.VALUES;
            var30 = var42.length;

            while (!var371.isEmpty()) {
                var361 = (RenderGlobal.ContainerLocalRenderInformation) var371.poll();
                var41 = var361.renderChunk;
                EnumFacing var451 = var361.facing;
                BlockPos var47 = var41.getPosition();
                ...
                for (int var48 = 0; var48 < var30; ++var48) {
                    EnumFacing var32 = var42[var48];

                    if ((!var391 || !var361.setFacing.contains(var32.getOpposite())) && (!var391 || var451 == null || var41.getCompiledChunk().isVisible(var451.getOpposite(), var32))) {
        ...
        if (Shaders.isShadowPass) {
            ...
            Iterator var40 = this.renderInfos.iterator();
            Lagometer.timerChunkUpdate.start();

            while (var40.hasNext()) {
                var361 = (RenderGlobal.ContainerLocalRenderInformation) var40.next();
                var41 = var361.renderChunk;

                if (var41.isNeedsUpdate() || var38.contains(var41)) {
                    this.displayListEntitiesDirty = true;
    ...
    public void renderSky(float partialTicks, int pass) {
        ...
        if (this.mc.theWorld.provider.getDimensionId() == 1) {
            ...
            if (var27 != null && Config.isSunMoonEnabled()) {
                ...
                var261.setColorRGBA_F(var10, var11, var12, var27[3]);
                var261.addVertex(0.0D, 100.0D, 0.0D);
                boolean var26 = true;
                var261.setColorRGBA_F(var27[0], var27[1], var27[2], 0.0F);
            ...
            double var30 = this.mc.thePlayer.getPositionEyes(partialTicks).yCoord - this.theWorld.getHorizon();
    ...
    public void renderClouds(float partialTicks, int pass) {
        if (!Config.isCloudsOff()) {
            if (Reflector.ForgeWorldProvider_getCloudRenderer.exists()) {
                WorldProvider w = this.mc.theWorld.provider;
                Object var3 = Reflector.call(w, Reflector.ForgeWorldProvider_getCloudRenderer, new Object[0]);
            ...
            if (this.mc.theWorld.provider.isSurfaceWorld()) {
                if (Config.isCloudsFancy()) {
                    ...
                    float var31 = (float) (this.mc.getRenderViewEntity().lastTickPosY + (this.mc.getRenderViewEntity().posY - this.mc.getRenderViewEntity().lastTickPosY) * (double) partialTicks);
                    boolean var4 = true;
                    boolean var5 = true;
                    ...
                    if (this.cloudRenderer.shouldUpdateGlList()) {
                        ...
                        var12 = 4.8828125E-4F;
                        double var261 = (double) ((float) this.cloudTickCounter + partialTicks);
                        double var15 = this.mc.getRenderViewEntity().prevPosX + (this.mc.getRenderViewEntity().posX - this.mc.getRenderViewEntity().prevPosX) * (double) partialTicks + var261 * 0.029999999329447746D;
                        double var17 = this.mc.getRenderViewEntity().prevPosZ + (this.mc.getRenderViewEntity().posZ - this.mc.getRenderViewEntity().prevPosZ) * (double) partialTicks;
    ...
    private void renderCloudsFancy(float partialTicks, int pass) {
        ...
        partialTicks = 0.0F;
        GlStateManager.disableCull();
        float var3 = (float) (this.mc.getRenderViewEntity().lastTickPosY + (this.mc.getRenderViewEntity().posY - this.mc.getRenderViewEntity().lastTickPosY) * (double) partialTicks);
        Tessellator var4 = Tessellator.getInstance();
        WorldRenderer var5 = var4.getWorldRenderer();
        float var6 = 12.0F;
        float var7 = 4.0F;
        double var8 = (double) ((float) this.cloudTickCounter + partialTicks);
        double var10 = (this.mc.getRenderViewEntity().prevPosX + (this.mc.getRenderViewEntity().posX - this.mc.getRenderViewEntity().prevPosX) * (double) partialTicks + var8 * 0.029999999329447746D) / 12.0D;
        double var12 = (this.mc.getRenderViewEntity().prevPosZ + (this.mc.getRenderViewEntity().posZ - this.mc.getRenderViewEntity().prevPosZ) * (double) partialTicks) / 12.0D + 0.33000001311302185D;
    ...
    public void renderWorldBorder(Entity p_180449_1_, float partialTicks) {
        ...
        if (p_180449_1_.posX >= var5.maxX() - var6 || p_180449_1_.posX <= var5.minX() + var6 || p_180449_1_.posZ >= var5.maxZ() - var6 || p_180449_1_.posZ <= var5.minZ() + var6) {
            ...
            double var10 = p_180449_1_.lastTickPosX + (p_180449_1_.posX - p_180449_1_.lastTickPosX) * (double) partialTicks;
            double var12 = p_180449_1_.lastTickPosY + (p_180449_1_.posY - p_180449_1_.lastTickPosY) * (double) partialTicks;
            double var14 = p_180449_1_.lastTickPosZ + (p_180449_1_.posZ - p_180449_1_.lastTickPosZ) * (double) partialTicks;
            GlStateManager.enableBlend();
            GlStateManager.tryBlendFuncSeparate(770, 1, 1, 0);
            this.renderEngine.bindTexture(locationForcefieldPng);
            GlStateManager.depthMask(false);
    ...
    public void drawBlockDamageTexture(Tessellator tessellatorIn, WorldRenderer worldRendererIn, Entity entityIn, float partialTicks) {
        double var5 = entityIn.lastTickPosX + (entityIn.posX - entityIn.lastTickPosX) * (double) partialTicks;
        double var7 = entityIn.lastTickPosY + (entityIn.posY - entityIn.lastTickPosY) * (double) partialTicks;
        double var9 = entityIn.lastTickPosZ + (entityIn.posZ - entityIn.lastTickPosZ) * (double) partialTicks;
    ...
    public void drawSelectionBox(EntityPlayer player, MovingObjectPosition movingObjectPositionIn, int p_72731_3_, float partialTicks) {
        if (p_72731_3_ == 0 && movingObjectPositionIn.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (var7.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(var6)) {
                ...
                double var8 = player.lastTickPosX + (player.posX - player.lastTickPosX) * (double) partialTicks;
                double var10 = player.lastTickPosY + (player.posY - player.lastTickPosY) * (double) partialTicks;
                double var12 = player.lastTickPosZ + (player.posZ - player.lastTickPosZ) * (double) partialTicks;
    ...
    public void playRecord(String recordName, BlockPos blockPosIn) {
        ...
        if (recordName != null) {
            ...
            PositionedSoundRecord var5 = PositionedSoundRecord.create(resource, (float) blockPosIn.getX(), (float) blockPosIn.getY(), (float) blockPosIn.getZ());
    ...
    public void playAuxSFX(EntityPlayer player, int sfxType, BlockPos blockPosIn, int p_180439_4_) {
        ...
        switch (sfxType) {
            ...
            case 2000:
                ...
                var9 = (double) blockPosIn.getX() + (double) var31 * 0.6D + 0.5D;
                var11 = (double) blockPosIn.getY() + 0.5D;
                var32 = (double) blockPosIn.getZ() + (double) var8 * 0.6D + 0.5D;
            ...
            case 2001:
                ...
                if (var6.getMaterial() != Material.air) {
                    this.mc.getSoundHandler().playSound(new PositionedSoundRecord(new ResourceLocation(var6.stepSound.getBreakSound()), (var6.stepSound.getVolume() + 1.0F) / 2.0F, var6.stepSound.getFrequency() * 0.8F, (float) blockPosIn.getX() + 0.5F, (float) blockPosIn.getY() + 0.5F, (float) blockPosIn.getZ() + 0.5F));
                }
            ...
            case 2002:
                var7 = (double) blockPosIn.getX();
                var9 = (double) blockPosIn.getY();
                var11 = (double) blockPosIn.getZ();
            ...
            case 2003:
                var7 = (double) blockPosIn.getX() + 0.5D;
                var9 = (double) blockPosIn.getY();
                var11 = (double) blockPosIn.getZ() + 0.5D;
            ...
            case 2004:
                for (var18 = 0; var18 < 20; ++var18) {
                    var19 = (double) blockPosIn.getX() + 0.5D + ((double) this.theWorld.rand.nextFloat() - 0.5D) * 2.0D;
                    var21 = (double) blockPosIn.getY() + 0.5D + ((double) this.theWorld.rand.nextFloat() - 0.5D) * 2.0D;
                    var23 = (double) blockPosIn.getZ() + 0.5D + ((double) this.theWorld.rand.nextFloat() - 0.5D) * 2.0D;
