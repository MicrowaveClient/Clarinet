...
public class BlockFluidRenderer {
    ...
    public boolean renderFluid(IBlockAccess blockAccess, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn) {
        ...
        int var7 = CustomColors.getFluidColor(blockAccess, blockStateIn, blockPosIn, renderEnv);
        ...
        if (!var11 && !var12 && !var13[0] && !var13[1] && !var13[2] && !var13[3]) {
            ...
            if (var11) {
                ...
                worldRendererIn.addVertexWithUV(var24 + 0.0D, var26 + (double) var21, var28 + 1.0D, (double) var34, (double) var52);
                worldRendererIn.addVertexWithUV(var24 + 1.0D, var26 + (double) var22, var28 + 1.0D, (double) var35, (double) var53);
                worldRendererIn.addVertexWithUV(var24 + 1.0D, var26 + (double) var23, var28 + 0.0D, (double) var36, (double) var54);
            ...
            for (int var571 = 0; var571 < 4; ++var571) {
                ...
                if (var13[var571]) {
                    ...
                    worldRendererIn.addVertexWithUV(var58, var26 + (double) var37, var61, (double) var47, (double) var49);
                    worldRendererIn.addVertexWithUV(var58, var26 + 0.0D, var61, (double) var47, (double) var50);
