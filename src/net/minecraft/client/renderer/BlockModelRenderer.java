...
public class BlockModelRenderer {
    ...
    public boolean renderModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides) {
        boolean var7 = Minecraft.isAmbientOcclusionEnabled() && blockStateIn.getBlock().getLightValue() == 0 && modelIn.isAmbientOcclusion();
    ...
    private void renderModelAmbientOcclusionQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, List listQuadsIn, RenderEnv renderEnv) {
        ...
        for (Iterator var221 = listQuadsIn.iterator(); var221.hasNext(); worldRendererIn.putPosition(var9, var11, var13)) {
            ...
            if (!var17.hasTintIndex() && colorMultiplier1 == -1) {
                ...
                worldRendererIn.putColorMultiplier(aoFaceIn.vertexColorMultiplier[0] * var19, aoFaceIn.vertexColorMultiplier[0] * var20, aoFaceIn.vertexColorMultiplier[0] * var21, 4);
                worldRendererIn.putColorMultiplier(aoFaceIn.vertexColorMultiplier[1] * var19, aoFaceIn.vertexColorMultiplier[1] * var20, aoFaceIn.vertexColorMultiplier[1] * var21, 3);
                worldRendererIn.putColorMultiplier(aoFaceIn.vertexColorMultiplier[2] * var19, aoFaceIn.vertexColorMultiplier[2] * var20, aoFaceIn.vertexColorMultiplier[2] * var21, 2);
                worldRendererIn.putColorMultiplier(aoFaceIn.vertexColorMultiplier[3] * var19, aoFaceIn.vertexColorMultiplier[3] * var20, aoFaceIn.vertexColorMultiplier[3] * var21, 1);
            }
        }
    }
    ...
    private void renderModelStandardQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing faceIn, int brightnessIn, boolean ownBrightness, WorldRenderer worldRendererIn, List listQuadsIn, RenderEnv renderEnv) {
        ...
        for (Iterator var231 = listQuadsIn.iterator(); var231.hasNext(); worldRendererIn.putPosition(var10, var12, var14)) {
            ...
            if (var241.hasTintIndex() || colorMultiplier2 != -1) {
                int var25;
    ...
    public static enum Orientation {
        ...
        private Orientation(String p_i46392_1_, int p_i46392_2_, String p_i46233_1_, int p_i46233_2_, EnumFacing p_i46233_3_, boolean p_i46233_4_) {
    ...
    static enum VertexTranslations {
        ...
        private VertexTranslations(String p_i46391_1_, int p_i46391_2_, String p_i46234_1_, int p_i46234_2_, int p_i46234_3_, int p_i46234_4_, int p_i46234_5_, int p_i46234_6_) {
