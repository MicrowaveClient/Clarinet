...
public class RenderChunk {
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        if (!var9.extendedLevelsInChunkCache()) {
            ...
            EnumWorldBlockLayer[] var26 = ENUM_WORLD_BLOCK_LAYERS;
            ...
            for (int var28 = 0; var28 < var27; ++var28) {
                ...
                if (var5.isLayerStarted(var29)) {
                    if (Config.isShaders()) {
                        SVertexBuilder.calcNormalChunkLayer(generator.getRegionRenderCacheBuilder().getWorldRendererByLayer(var29));
                    }
