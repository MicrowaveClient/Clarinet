...
public class ItemRenderer {
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                switch (ItemRenderer.SwitchEnumAction.ENUMACTION_INT_REMAP[var7.ordinal()]) {
                    ...
                    case 4:
                        this.transformFirstPersonItem(-0.25F, var4);
                        this.func_178103_d();
                        break;
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
            ...
            if (var2.getBlock().getRenderType() != -1) {
                ...
                if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderBlockOverlay, new Object[]{this.mc.thePlayer, Float.valueOf(partialTicks), var13, var2, blockPos})) {
    ...
    private void renderFireInFirstPerson(float p_78442_1_) {
        RenderFireSubject renderFireSubject = new RenderFireSubject();
        Glade.getInstance().getSubjectManager().dispatch(renderFireSubject);
        if (renderFireSubject.isCancelled())
            return;
        Tessellator var2 = Tessellator.getInstance();
        WorldRenderer var3 = var2.getWorldRenderer();
