...
public class FaceBakery {
    ...
    private float getFaceBrightness(EnumFacing facing) {
        switch (FaceBakery.SwitchEnumFacing.FACING_LOOKUP[facing.ordinal()]) {
            case 1:
                if (Config.isShaders()) {
    ...
    public static EnumFacing getFacingFromVertexData(int[] faceData) {
        ...
        Vector3f var2 = new Vector3f(Float.intBitsToFloat(faceData[step]), Float.intBitsToFloat(faceData[step + 1]), Float.intBitsToFloat(faceData[step + 2]));
        Vector3f var3 = new Vector3f(Float.intBitsToFloat(faceData[step2]), Float.intBitsToFloat(faceData[step2 + 1]), Float.intBitsToFloat(faceData[step2 + 2]));
    ...
    private void func_178408_a(int[] p_178408_1_, EnumFacing p_178408_2_) {
        ...
        EnumFaceing var181 = EnumFaceing.getFacing(p_178408_2_);
