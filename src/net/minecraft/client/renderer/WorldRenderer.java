...
public class WorldRenderer {
    ...
    public void putColorMultiplier(float red, float green, float blue, int p_178978_4_) {
        ...
        if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
            var7 = (int) ((float) (var6 & 255) * red);
            var8 = (int) ((float) (var6 >> 8 & 255) * green);
            var9 = (int) ((float) (var6 >> 16 & 255) * blue);
            var6 &= -16777216;
            var6 |= var9 << 16 | var8 << 8 | var7;
        } else {
            var7 = (int) ((float) (this.color >> 24 & 255) * red);
            var8 = (int) ((float) (this.color >> 16 & 255) * green);
            var9 = (int) ((float) (this.color >> 8 & 255) * blue);
            var6 &= 255;
