        ...
        if (var2 != null) {
            ...
            if (!Reflector.postForgeBusEvent(Reflector.RenderItemInFrameEvent_Constructor, new Object[]{itemFrame, this})) {
                if (var4 instanceof ItemMap) {
                    ...
                    MapData var13 = Items.filled_map.getMapData(var3.getEntityItem(), itemFrame.worldObj);
                    ...
                    if (var4 == Items.compass) {
                        var121 = this.mc.getTextureMapBlocks().getAtlasSprite(TextureCompass.field_176608_l);
                        ...
                        if (var121 instanceof TextureCompass) {
                            ...
                            var131.updateCompass(itemFrame.worldObj, itemFrame.posX, itemFrame.posZ, (double) MathHelper.wrapAngleTo180_float((float) (180 + itemFrame.facingDirection.getHorizontalIndex() * 90)), false, true);
