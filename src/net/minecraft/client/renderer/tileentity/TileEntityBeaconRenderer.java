...
public class TileEntityBeaconRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderBeacon(TileEntityBeacon entityBeacon, double p_180536_2_, double p_180536_4_, double p_180536_6_, float p_180536_8_, int p_180536_9_) {
        ...
        if (var10 > 0.0F) {
            ...
            List var13 = entityBeacon.getBeamSegments();
            int var14 = 0;
            ...
            for (int var15 = 0; var15 < var13.size(); ++var15) {
                ...
                float var18 = (float) entityBeacon.getWorld().getTotalWorldTime() + p_180536_8_;
                ...
                double var46 = (double) ((float) var16.getHeight() * var10) * (0.5D / var22) + var44;
                var12.setColorRGBA_F(var16.getColors()[0], var16.getColors()[1], var16.getColors()[2], 0.125F);
                ...
                var42 = (double) ((float) var16.getHeight() * var10) + var40;
