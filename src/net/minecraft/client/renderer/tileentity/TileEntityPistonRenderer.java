...
public class TileEntityPistonRenderer extends TileEntitySpecialRenderer {
    ...
    public void func_178461_a(TileEntityPiston piston, double p_178461_2_, double p_178461_4_, double p_178461_6_, float p_178461_8_, int p_178461_9_) {
        ...
        if (var12.getMaterial() != Material.air && piston.getProgress(p_178461_8_) < 1.0F) {
            ...
            var14.setTranslation((double) ((float) p_178461_2_ - (float) var10.getX() + piston.getOffsetX(p_178461_8_)), (double) ((float) p_178461_4_ - (float) var10.getY() + piston.getOffsetY(p_178461_8_)), (double) ((float) p_178461_6_ - (float) var10.getZ() + piston.getOffsetZ(p_178461_8_)));
            var14.setColorOpaque_F(1.0F, 1.0F, 1.0F);
            World var15 = this.getWorld();

            if (var12 == Blocks.piston_head && piston.getProgress(p_178461_8_) < 0.5F) {
                ...
                var17 = var17.withProperty(BlockPistonExtension.SHORT, Boolean.valueOf(piston.getProgress(p_178461_8_) >= 0.5F));
