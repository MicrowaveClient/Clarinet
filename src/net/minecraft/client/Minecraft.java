...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        Glade.getInstance().getSubjectManager().dispatch(new StartupSubject());
    }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            ...
            DeathSubject deathSubject = new DeathSubject();
            Glade.getInstance().getSubjectManager().dispatch(deathSubject);
            if (!deathSubject.isCancelled())
    ...
    public void shutdownMinecraftApplet() {
        Glade.getInstance().getSubjectManager().dispatch(new ShutdownSubject());
        try {
    ...
    private void clickMouse() {
        Glade.getInstance().getSubjectManager().dispatch(new ActionSubject(ActionSubject.Type.LEFT_CLICK));
    ...
    private void rightClickMouse() {
        Glade.getInstance().getSubjectManager().dispatch(new ActionSubject(ActionSubject.Type.RIGHT_CLICK));
    ...
    public void runTick() throws IOException {
        TickSubject tickSubject = new TickSubject();
        Glade.getInstance().getSubjectManager().dispatch(tickSubject);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Glade.getInstance().getSubjectManager().dispatch(new ActionSubject(ActionSubject.Type.KEY_PRESS));
    ...
    private void middleClickMouse() {
        Glade.getInstance().getSubjectManager().dispatch(new ActionSubject(ActionSubject.Type.MIDDLE_CLICK));
        if (this.objectMouseOver != null) {
    ...
    public String processLogin(String username, String password) {
        if (username == null || username.length() < 0 || password == null || password.length() <= 0) {
            ...
            try {
                b.logIn();
                setSession(new Session(b.getSelectedProfile().getName(),
                        b.getSelectedProfile().getId().toString(), b.getAuthenticatedToken(), "mojang"));
