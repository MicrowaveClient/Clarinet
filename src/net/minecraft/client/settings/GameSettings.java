...
public class GameSettings {
    ...
    private String getKeyBindingOF(GameSettings.Options par1EnumOptions) {
        ...
        if (par1EnumOptions == GameSettings.Options.RENDER_DISTANCE) {
            ...
            return this.ofChunkLoading == 1 ? var2 + Lang.get("of.options.chunkLoading.smooth") : (this.ofChunkLoading == 2 ? var2 + Lang.get("of.options.chunkLoading.multiCore") : var2 + Lang.getDefault());
            ...
            if (this.ofAaLevel != Config.getAntialiasingLevel()) {
                var61 = " (" + Lang.get("of.general.restart") + ")";
            }

            return this.ofAaLevel == 0 ? var2 + Lang.getOff() + var61 : var2 + this.ofAaLevel + var61;
    ...
    public static enum Options {
        ...
        CHUNK_LOADING("CHUNK_LOADING", 97, "", 999, "of.options.CHUNK_LOADING", false, false),
