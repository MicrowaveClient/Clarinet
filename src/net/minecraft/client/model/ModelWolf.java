...
public class ModelWolf extends ModelBase {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        EntityWolf var5 = (EntityWolf) entitylivingbaseIn;
        ...
        this.wolfHeadMain.rotateAngleZ = var5.getInterestedAngle(partialTickTime) + var5.getShakeAngle(partialTickTime, 0.0F);
        this.wolfMane.rotateAngleZ = var5.getShakeAngle(partialTickTime, -0.08F);
        this.wolfBody.rotateAngleZ = var5.getShakeAngle(partialTickTime, -0.16F);
        this.wolfTail.rotateAngleZ = var5.getShakeAngle(partialTickTime, -0.2F);
    }
