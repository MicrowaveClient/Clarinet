...
public class ModelIronGolem extends ModelBase {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        EntityIronGolem var5 = (EntityIronGolem) entitylivingbaseIn;
        int var6 = var5.getAttackTimer();

        if (var6 > 0) {
            this.ironGolemRightArm.rotateAngleX = -2.0F + 1.5F * this.func_78172_a((float) var6 - partialTickTime, 10.0F);
            this.ironGolemLeftArm.rotateAngleX = -2.0F + 1.5F * this.func_78172_a((float) var6 - partialTickTime, 10.0F);
        } else {
