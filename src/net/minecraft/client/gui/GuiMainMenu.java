...
import me.nuf.glade.screens.accountmanager.GuiAccountScreen;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.buttonList.add(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Accounts", new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
       ...
       fontRendererObj.drawSpecialCenteredStringWithShadow(fontRendererObj, Glade.TITLE, width / 14, 4, 0xFFFFFFFF);
        GlStateManager.popMatrix();
