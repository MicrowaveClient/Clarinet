                        ...
                        if (var11 < 200 || var3) {
                            ...
                            if (var14 > 3) {
                                ...
                                if (chatMessageSubject.isCancelled())
                                    chatMessageSubject.setText(Glade.getInstance().getFriendManager().replace(var17));
                                GlStateManager.enableBlend();
                                this.mc.fontRendererObj.drawStringWithShadow(chatMessageSubject.getText(), (float) var15, (float) (var16 - 8), 16777215 + (var14 << 24));
