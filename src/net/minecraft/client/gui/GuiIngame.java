...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (this.mc.gameSettings.keyBindPlayerList.isKeyDown() && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.getPlayerInfoMap().size() > 1 || var161 != null)) {
        ...
        Glade.getInstance().getSubjectManager().dispatch(new GameOverlaySubject());
    }
    ...
    public void renderDemo(ScaledResolution p_175185_1_) {
        ...
        this.getFontRenderer().drawStringWithShadow(var2, (float) (p_175185_1_.getScaledWidth() - var3 - 10), 5.0F, 16777215);
        this.mc.mcProfiler.endSection();
    }
    ...
    private void renderBossHealth() {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
            ...
            this.getFontRenderer().drawStringWithShadow(var8, (float) (var3 / 2 - this.getFontRenderer().getStringWidth(var8) / 2), (float) (var7 - 10), bossTextColor);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            this.mc.getTextureManager().bindTexture(icons);
        }
    }
