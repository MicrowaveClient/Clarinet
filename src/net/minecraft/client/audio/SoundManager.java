...
public class SoundManager {
            ...
            if (this.sndSystem.getMasterVolume() <= 0.0F) {
                ...
                if (var2 == null) {
                    ...
                    if (var3 == SoundHandler.missing_sound) {
                        ...
                        double var8 = (double) this.getNormalizedPitch(sound, var3);
    ...
    public void setListener(EntityPlayer player, float p_148615_2_) {
        if (this.loaded && player != null) {
            ...
            double var5 = player.prevPosX + (player.posX - player.prevPosX) * (double) p_148615_2_;
            double var7 = player.prevPosY + (player.posY - player.prevPosY) * (double) p_148615_2_ + (double) player.getEyeHeight();
            double var9 = player.prevPosZ + (player.posZ - player.prevPosZ) * (double) p_148615_2_;
