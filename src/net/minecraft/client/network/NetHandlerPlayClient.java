...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
        ...
        if (packetIn.getType() == 10) {
            ...
            var8 = new EntityLargeFireball(this.clientWorldController, var2, var4, var6, (double) packetIn.getSpeedX() / 8000.0D, (double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
            packetIn.func_149002_g(0);
        } else if (packetIn.getType() == 64) {
            var8 = new EntitySmallFireball(this.clientWorldController, var2, var4, var6, (double) packetIn.getSpeedX() / 8000.0D, (double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
            packetIn.func_149002_g(0);
        } else if (packetIn.getType() == 66) {
            var8 = new EntityWitherSkull(this.clientWorldController, var2, var4, var6, (double) packetIn.getSpeedX() / 8000.0D, (double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
            packetIn.func_149002_g(0);
        ...
        if (var8 != null) {
            ...
            if (packetIn.func_149009_m() > 0) {
                ...
                ((Entity) var8).setVelocity((double) packetIn.getSpeedX() / 8000.0D, (double) packetIn.getSpeedY() / 8000.0D, (double) packetIn.getSpeedZ() / 8000.0D);
            }
        }
    }
    ...
    public void handleSpawnExperienceOrb(S11PacketSpawnExperienceOrb packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        EntityXPOrb var2 = new EntityXPOrb(this.clientWorldController, (double) packetIn.getX(), (double) packetIn.getY(), (double) packetIn.getZ(), packetIn.getXPValue());
        var2.serverPosX = packetIn.getX();
        var2.serverPosY = packetIn.getY();
        var2.serverPosZ = packetIn.getZ();
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
        ...
        var10.prevPosX = var10.lastTickPosX = (double) (var10.serverPosX = packetIn.getX());
        var10.prevPosY = var10.lastTickPosY = (double) (var10.serverPosY = packetIn.getY());
        var10.prevPosZ = var10.lastTickPosZ = (double) (var10.serverPosZ = packetIn.getZ());
        int var11 = packetIn.getCurrentItemID();
    ...
    public void handleEntityHeadLook(S19PacketEntityHeadLook packetIn) {
        ...
        if (var2 != null) {
            float var3 = (float) (packetIn.getYaw() * 360) / 256.0F;
    ...
    public void handleDestroyEntities(S13PacketDestroyEntities packetIn) {
        ...
        for (int var2 = 0; var2 < packetIn.getEntityIDs().length; ++var2) {
            this.clientWorldController.removeEntityFromWorld(packetIn.getEntityIDs()[var2]);
        }
    }
    ...
    public void handleChunkData(S21PacketChunkData packetIn) {
        ...
        var2.fillChunk(packetIn.func_149272_d(), packetIn.getExtractedSize(), packetIn.func_149274_i());
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        PacketSubject packetSubject = new PacketSubject(p_147297_1_);
        Glade.getInstance().getSubjectManager().dispatch(packetSubject);
        if (packetSubject.isCancelled())
            return;
        this.netManager.sendPacket(packetSubject.getPacket());
    }
    ...
    public void handleEntityStatus(S19PacketEntityStatus packetIn) {
        ...
        if (var2 != null) {
            if (packetIn.getOpCode() == 21) {
                ...
                var2.handleHealthUpdate(packetIn.getOpCode());
            }
        }
    }
    ...
    public void handleExplosion(S27PacketExplosion packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Explosion var2 = new Explosion(this.gameController.theWorld, (Entity) null, packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getStrength(), packetIn.getAffectedBlockPositions());
    ...
    public void handleConfirmTransaction(S32PacketConfirmTransaction packetIn) {
        ...
        } else if (packetIn.getWindowId() == var3.openContainer.windowId) {
    ...
    public void handleWindowItems(S30PacketWindowItems packetIn) {
        ...
        if (packetIn.func_148911_c() == 0) {
            var2.inventoryContainer.putStacksInSlots(packetIn.getItemStacks());
        } else if (packetIn.func_148911_c() == var2.openContainer.windowId) {
            var2.openContainer.putStacksInSlots(packetIn.getItemStacks());
        }
    }
    ...
    public void handleUpdateSign(S33PacketUpdateSign packetIn) {
        ...
        if (this.gameController.theWorld.isBlockLoaded(packetIn.getPos())) {
            TileEntity var3 = this.gameController.theWorld.getTileEntity(packetIn.getPos());

            if (var3 instanceof TileEntitySign) {
                TileEntitySign var4 = (TileEntitySign) var3;

                if (var4.getIsEditable()) {
                    System.arraycopy(packetIn.getLines(), 0, var4.signText, 0, 4);
                    var4.markDirty();
                }
    ...
    public void handleUpdateTileEntity(S35PacketUpdateTileEntity packetIn) {
        ...
        if (this.gameController.theWorld.isBlockLoaded(packetIn.getPos())) {
            TileEntity var2 = this.gameController.theWorld.getTileEntity(packetIn.getPos());
    ...
    public void handleWindowProperty(S31PacketWindowProperty packetIn) {
        ...
        if (var2.openContainer != null && var2.openContainer.windowId == packetIn.getWindowId()) {
            var2.openContainer.updateProgressBar(packetIn.getVarIndex(), packetIn.getVarValue());
        }
    }
    ...
    public void handleEntityEquipment(S04PacketEntityEquipment packetIn) {
        ...
        if (var2 != null) {
            var2.setCurrentItemOrArmor(packetIn.getEquipmentSlot(), packetIn.getItemStack());
        }
    }
    ...
    public void handleMapChunkBulk(S26PacketMapChunkBulk packetIn) {
        ...
        for (int var2 = 0; var2 < packetIn.getChunkCount(); ++var2) {
            int var3 = packetIn.getChunkX(var2);
            int var4 = packetIn.getChunkZ(var2);
            ...
            var5.fillChunk(packetIn.getChunkBytes(var2), packetIn.getChunkSize(var2), true);
    ...
    public void handleStatistics(S37PacketStatistics packetIn) {
        ...
        for (Iterator var3 = packetIn.func_148974_c().entrySet().iterator(); var3.hasNext(); this.gameController.thePlayer.getStatFileWriter().unlockAchievement(this.gameController.thePlayer, var5, var6)) {
    ...
    public void handleCombatEvent(S42PacketCombatEvent packetIn) {
        ...
        if (packetIn.eventType == S42PacketCombatEvent.Event.END_COMBAT) {
            ...
            if (var7 instanceof EntityPlayer) {
                ...
                var5.func_152807_a(packetIn.deathMessage);
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn) {
        ...
        if (var2.startsWith("level://")) {
            ...
            if (var6.isFile()) {
                ...
                Futures.addCallback(this.gameController.getResourcePackRepository().setResourcePackInstance(var6), new FutureCallback() {
    ...
    public void handleEntityNBT(S49PacketUpdateEntityNBT packetIn) {
        ...
        if (var2 != null) {
            var2.clientUpdateEntityNBT(packetIn.getTagCompound());
        }
    }
