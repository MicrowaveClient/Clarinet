...
import me.nuf.glade.subjects.PotionSubject;
...
public class PotionEffect {
    ...
    public boolean onUpdate(EntityLivingBase entityIn) {
        if (this.duration > 0) {
            ...
            PotionSubject potionSubject = new PotionSubject();
            Glade.getInstance().getSubjectManager().dispatch(potionSubject);

            if (!potionSubject.isCancelled())
