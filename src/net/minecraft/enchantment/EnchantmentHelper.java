...
public class EnchantmentHelper {
    ...
    public static List buildEnchantmentList(Random randomIn, ItemStack itemStackIn, int p_77513_2_) {
        ...
        if (var4 <= 0) {
            ...
            var4 /= 2;
            var4 = 1 + randomIn.nextInt((var4 >> 1) + 1) + randomIn.nextInt((var4 >> 1) + 1);
            int var5 = var4 + p_77513_2_;
            float var6 = (randomIn.nextFloat() + randomIn.nextFloat() - 1.0F) * 0.15F;
            ...
            ArrayList var8 = null;
            Map var9 = mapEnchantmentData(var7, itemStackIn);

            if (var9 != null && !var9.isEmpty()) {
                EnchantmentData var10 = (EnchantmentData) WeightedRandom.getRandomItem(randomIn, var9.values());

                if (var10 != null) {
                    var8 = Lists.newArrayList();
                    var8.add(var10);

                    for (int var11 = var7; randomIn.nextInt(50) <= var11; var11 >>= 1) {
                        ...
                        if (!var9.isEmpty()) {
                            EnchantmentData var17 = (EnchantmentData) WeightedRandom.getRandomItem(randomIn, var9.values());
                            var8.add(var17);
                        }
                    }
                }
