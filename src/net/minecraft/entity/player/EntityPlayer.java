...
import me.nuf.glade.subjects.InsideOpaqueBlockSubject;
...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    private Collection func_175137_e(Entity p_175137_1_) {
        ...
        if (var2 != null) {
            ...
            if (var3 >= 0 && var3 < IScoreObjectiveCriteria.field_178793_i.length) {
                Iterator var4 = this.getWorldScoreboard().getObjectivesFromCriteria(IScoreObjectiveCriteria.field_178793_i[var3]).iterator();
    ...
    protected void damageEntity(DamageSource damageSrc, float damageAmount) {
        if (!this.isEntityInvulnerable(damageSrc)) {
            ...
            if (damageAmount != 0.0F) {
                ...
                this.getCombatTracker().trackDamage(damageSrc, var4, damageAmount);
                ...
                if (var2 > 0.0F || var4 > 0.0F) {
                    ...
                    if (var14) {
                        if (var18 > 0) {
                            ...
                            PlayerSprintingSubject playerSprintingSubject = new PlayerSprintingSubject();
                            Glade.getInstance().getSubjectManager().dispatch(playerSprintingSubject);
                            if (!playerSprintingSubject.isCancelled()) {
                                this.motionX *= 0.6D;
                                this.motionZ *= 0.6D;
    ...
    public boolean isEntityInsideOpaqueBlock() {
        InsideOpaqueBlockSubject insideOpaqueBlockSubject = new InsideOpaqueBlockSubject();
        Glade.getInstance().getSubjectManager().dispatch(insideOpaqueBlockSubject);
        if (insideOpaqueBlockSubject.isCancelled())
            return false;
    ...
    public EntityPlayer.EnumStatus trySleep(BlockPos bedLocation) {
        if (!this.worldObj.isRemote) {
            ...
            double var2 = 8.0D;
            double var4 = 5.0D;
            List var6 = this.worldObj.getEntitiesWithinAABB(EntityMob.class, new AxisAlignedBB((double) bedLocation.getX() - var2, (double) bedLocation.getY() - var4, (double) bedLocation.getZ() - var2, (double) bedLocation.getX() + var2, (double) bedLocation.getY() + var4, (double) bedLocation.getZ() + var2));
        ...
        if (this.worldObj.isBlockLoaded(bedLocation)) {
            ...
            this.setPosition((double) ((float) bedLocation.getX() + var3), (double) ((float) bedLocation.getY() + 0.6875F), (double) ((float) bedLocation.getZ() + var8));
        } else {
    ...
    public boolean isInvisibleToPlayer(EntityPlayer player) {
        if (!this.isInvisible()) {
            ...
            Team var2 = this.getTeam();
            return var2 == null || player == null || player.getTeam() != var2 || !var2.getSeeFriendlyInvisiblesEnabled();
        }
    }
    ...
    public boolean isPushedByWater() {
        PushedByWaterSubject pushedByWaterSubject = new PushedByWaterSubject();
        Glade.getInstance().getSubjectManager().dispatch(pushedByWaterSubject);
        if (pushedByWaterSubject.isCancelled())
            return false;
        return !this.capabilities.isFlying;
    }
