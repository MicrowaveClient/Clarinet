...
public class InventoryPlayer implements IInventory {
    ...
    public int clearMatchingItems(Item itemIn, int metadataIn, int removeCount, NBTTagCompound itemNBT) {
        ...
        for (var6 = 0; var6 < this.mainInventory.length; ++var6) {
            ...
            if (var7 != null && (itemIn == null || var7.getItem() == itemIn) && (metadataIn <= -1 || var7.getMetadata() == metadataIn) && (itemNBT == null || CommandTestForBlock.func_175775_a(itemNBT, var7.getTagCompound(), true))) {
                var8 = removeCount <= 0 ? var7.stackSize : Math.min(removeCount - var5, var7.stackSize);
                var5 += var8;
                ...
                if (removeCount != 0) {
                    ...
                    if (removeCount > 0 && var5 >= removeCount) {
                        return var5;
                    }
                }
            }
        ...
        for (var6 = 0; var6 < this.armorInventory.length; ++var6) {
            ...
            if (var7 != null && (itemIn == null || var7.getItem() == itemIn) && (metadataIn <= -1 || var7.getMetadata() == metadataIn) && (itemNBT == null || CommandTestForBlock.func_175775_a(itemNBT, var7.getTagCompound(), false))) {
                var8 = removeCount <= 0 ? var7.stackSize : Math.min(removeCount - var5, var7.stackSize);
                var5 += var8;
        ...
        if (this.itemStack != null) {
            ...
            if (itemNBT != null && !CommandTestForBlock.func_175775_a(itemNBT, this.itemStack.getTagCompound(), false)) {
                return var5;
            }

            var6 = removeCount <= 0 ? this.itemStack.stackSize : Math.min(removeCount - var5, this.itemStack.stackSize);
            var5 += var6;
    ...
    public boolean canHeldItemHarvest(Block blockIn) {
        if (blockIn.getMaterial().isToolNotRequired()) {
            ...
            return var2 != null ? var2.canHarvestBlock(blockIn) : false;
        }
    }
