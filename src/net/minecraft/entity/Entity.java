...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        PlayerMoveSubject playerMoveSubject = new PlayerMoveSubject(x, y, z);
        if (this instanceof EntityPlayer) {
            Glade.getInstance().getSubjectManager().dispatch(playerMoveSubject);
            x = playerMoveSubject.getX();
            y = playerMoveSubject.getY();
            z = playerMoveSubject.getZ();
        }
        if (this.noClip) {
            ...
            double var15 = y;
            double var17 = z;
            boolean var19 = this.onGround && playerMoveSubject.isSafety() && this instanceof EntityPlayer;
            ...
            if (this == Minecraft.getMinecraft().thePlayer) {
                StepSubject stepSubject = new StepSubject(StepSubject.Time.PRE, (float) stepHeight);
                Glade.getInstance().getSubjectManager().dispatch(stepSubject);
                stepHeight = stepSubject.getStepHeight();
            }
            ...
            if (this.stepHeight > 0.0F && var54 && (var13 != x || var17 != z)) {
                ...
                if (this == Minecraft.getMinecraft().thePlayer) {
                    StepSubject stepSubject2 = new StepSubject(StepSubject.Time.POST, (float) stepHeight);
                    Glade.getInstance().getSubjectManager().dispatch(stepSubject2);
                }
            }
            ...
            AirRunSubject airRunSubject = new AirRunSubject();
            Glade.getInstance().getSubjectManager().dispatch(airRunSubject);

            this.onGround = (this.isCollidedVertically && var15 < 0.0D) || airRunSubject.isCancelled();
