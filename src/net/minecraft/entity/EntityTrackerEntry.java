...
public class EntityTrackerEntry {
        ...
        if (playerMP != this.trackedEntity) {
            if (this.func_180233_c(playerMP)) {
                if (!this.trackingPlayers.contains(playerMP) && (this.isPlayerWatchingThisChunk(playerMP) || this.trackedEntity.forceSpawn)) {
                    ...
                    playerMP.playerNetServerHandler.sendPacket(var2);
                    ...
                    if (var3 != null) {
                        playerMP.playerNetServerHandler.sendPacket(new S49PacketUpdateEntityNBT(this.trackedEntity.getEntityId(), var3));
                    }
                    ...
                    if (this.trackedEntity instanceof EntityLivingBase) {
                        ...
                        if (!var5.isEmpty()) {
                            playerMP.playerNetServerHandler.sendPacket(new S20PacketEntityProperties(this.trackedEntity.getEntityId(), var5));
                        }
                    }
                    ...
                    if (this.trackedEntity instanceof EntityLivingBase) {
                        for (int var7 = 0; var7 < 5; ++var7) {
                            ...
                            if (var10 != null) {
                                playerMP.playerNetServerHandler.sendPacket(new S04PacketEntityEquipment(this.trackedEntity.getEntityId(), var7, var10));
                            }
                        }
                    }
                    ...
                    if (this.trackedEntity instanceof EntityPlayer) {
                        ...
                        if (var8.isPlayerSleeping()) {
                            playerMP.playerNetServerHandler.sendPacket(new S0APacketUseBed(var8, new BlockPos(this.trackedEntity)));
                        }
                    }
                    ...
                    if (this.trackedEntity instanceof EntityLivingBase) {
                        ...
                        while (var11.hasNext()) {
                            ...
                            playerMP.playerNetServerHandler.sendPacket(new S1DPacketEntityEffect(this.trackedEntity.getEntityId(), var6));
                        }
                    }
                }
    ...
    public boolean func_180233_c(EntityPlayerMP playerMP) {
        double var2 = playerMP.posX - (double) (this.encodedPosX / 32);
        double var4 = playerMP.posZ - (double) (this.encodedPosZ / 32);
        return var2 >= (double) (-this.trackingDistanceThreshold) && var2 <= (double) this.trackingDistanceThreshold && var4 >= (double) (-this.trackingDistanceThreshold) && var4 <= (double) this.trackingDistanceThreshold && this.trackedEntity.isSpectatedByPlayer(playerMP);
    }
