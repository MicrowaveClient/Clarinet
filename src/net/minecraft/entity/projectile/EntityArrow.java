                    ...
                    if (var6.entityHit.attackEntityFrom(var26, (float) var24)) {
                        if (var6.entityHit instanceof EntityLivingBase) {
                            ...
                            if (this.shootingEntity instanceof EntityLivingBase) {
                                EnchantmentHelper.applyThornEnchantments(var27, this.shootingEntity);
                                EnchantmentHelper.applyArthropodEnchantments((EntityLivingBase) this.shootingEntity, var27);
                            }
