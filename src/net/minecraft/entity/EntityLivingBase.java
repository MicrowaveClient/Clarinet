...
public abstract class EntityLivingBase extends Entity {
    ...
    public boolean isPotionApplicable(PotionEffect potioneffectIn) {
        if (this.getCreatureAttribute() == EnumCreatureAttribute.UNDEAD) {
            int var2 = potioneffectIn.getPotionID();
    ...
    public void removePotionEffect(int potionId) {
        PotionEffect var2 = (PotionEffect) this.activePotionsMap.remove(Integer.valueOf(potionId));
    ...
    public void renderBrokenItemStack(ItemStack stack) {
        ...
        for (int var2 = 0; var2 < 5; ++var2) {
            ...
            this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, var6.xCoord, var6.yCoord, var6.zCoord, var3.xCoord, var3.yCoord + 0.05D, var3.zCoord, new int[]{Item.getIdFromItem(stack.getItem())});
        }
    }
